...
#define CNF_SYSTEMAREA_END	0x340FC000	/* Guardian-TRON: kernel memory must stay below the 16 KB MSP stack
					   (0x340FC000-0x34100000); 0x34100000+ belongs to the NPU activation pool */

#define	CNF_MAX_TSKPRI		32	/* Task Max priority */

#define CNF_TIMER_PERIOD	1	/* System timer period [ms] (Guardian-TRON: 1 ms tick, was 10) */
