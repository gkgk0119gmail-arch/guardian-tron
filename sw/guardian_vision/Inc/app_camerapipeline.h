...
int  CameraPipeline_Init(uint32_t *lcd_bg_width, uint32_t *lcd_bg_height, uint32_t *pitch_nn);  /* 0 ok, <0 sensor not answering */
...
int  CameraPipeline_IspUpdate(void);   /* 0 ok, <0 sensor I2C error (non-fatal) */
